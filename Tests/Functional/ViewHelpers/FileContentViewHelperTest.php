...
class FileContentViewHelperTest extends FunctionalTestCase
{
    ...
    public function initializeArguments_should_registerArguments(): void
    {
        ...
        $subject
            ...
            ->willReturnCallback(
                static fn($name, $type, $description, $required, $defaultValue) => match (true) {
    ...
    public function renderStatic_should_return_external_png_as_base64_data_uri(): void
    {
        ...
        $this->assertSame(
            'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAoAAAAKCAYAAACNMs+9AAAACXBIWXMAAAsTAAALEwEAmpwYAAAASElEQVR4nM3PuwnAQAwD0Nt/L4N9uPQPg2dR4Jo0KdIlhQqh12jNDN5kfQyrCswMEUFmnr73hqrCzG7Y3SCiM7o7IuIZ/vz1BTJjZDjTiAewAAAAAElFTkSuQmCC',
            $result,
        );
    }
