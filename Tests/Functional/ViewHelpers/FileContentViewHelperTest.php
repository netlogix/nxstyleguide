...
class FileContentViewHelperTest extends FunctionalTestCase
{
    ...
    public function renderStatic_should_return_svg(): void
    {
        ...
        $this->assertSame('<svg xmlns="http://www.w3.org/2000/svg" height="100" width="100"><circle cx="50" cy="50" r="40" fill="red"/></svg>', $result);
    }
    ...
    public function renderStatic_should_return_svg_with_placeholder_replaced(): void
    {
        ...
        $this->assertSame('<svg xmlns="http://www.w3.org/2000/svg" height="100" width="100"><circle cx="50" cy="50" r="40" fill="blue"/></svg>', $result);
    }
    ...
    public function renderStatic_should_return_css_with_base_and_correct_source_map(): void
    {
        ...
        $this->assertStringContainsString('/styleguide/test.jpg', $result);
        $this->assertStringContainsString('sourceMappingURL=https://cdn.example.com/typo3conf/ext/nxwebsite/Resources/Public/Build/Css/styleguide.css.map', $result);
    }
    ...
    public function renderStatic_should_return_external_png_as_base64_data_uri(): void
    {
        ...
        $subject->setArguments([
            'file' => 'https://placehold.co/1x1.png',
            'baseUri' => '',
            'mimeType' => 'image/png',
            'arguments' => [],
            'dataUri' => true,
        ...
        $this->assertSame('data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAoAAAAKCAYAAACNMs+9AAAACXBIWXMAAAsTAAALEwEAmpwYAAAASElEQVR4nM3PuwnAQAwD0Nt/L4N9uPQPg2dR4Jo0KdIlhQqh12jNDN5kfQyrCswMEUFmnr73hqrCzG7Y3SCiM7o7IuIZ/vz1BTJjZDjTiAewAAAAAElFTkSuQmCC', $result);
    }
